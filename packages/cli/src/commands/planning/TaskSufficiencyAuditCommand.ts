    ...
    try {
          ...
          JSON.stringify(
            {
              ...
              finalTotalSignals: result.finalTotalSignals,
              ...
              unresolvedBundles: result.unresolvedBundles,
      ...
      if (!parsed.quiet) {
        const lines = [
          ...
          `Total SDS signals: ${result.finalTotalSignals}`,
          ...
          `Remaining unresolved bundles: ${result.unresolvedBundles.length}`,
