...
const usage = [
    "mcoda order-tasks --input <path/to/tasks.md> [--workspace <name>] [--token-usage <path>] [--runs <path>] [--out .mcoda/order/order-<name>.md] [--overwrite]",
    "",
    "Produces a simple dependency-ordered task list (prototype helper).",
].join("\n");
